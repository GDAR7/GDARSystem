...
function rPanelHoras(){
  ...
  let tabs=[[1,'📅 Horas por Día'],[2,'🎯 Utilización Semanal'],[3,'🔧 Disponibilidad Mecánica'],[4,'🛵 Disponibilidad Menores'],[5,'📄 Resumen Semanal'],[6,'📊 Utilización Diaria'],[7,'📈 Reporte Mensual']];
  const ok=_phTabsOk();
  if(ok){
  ...
  // Reporte mensual: la semana contra el corte (js/panelHorasMes.js)
  if(_phTab===7&&typeof _phmRender==='function'){_phmRender();return;}
  _phRenderHoras();
}
