...
const AREAS={
  ...
  costControl:{label:'Cost Control',icon:'📈',color:'#059669',prefix:'ECOCC',
    modules:[{key:'costControl',label:'Cost Control',icon:'📊'},{key:'tarifas',label:'Tarifas',icon:'🏷️'},{key:'venta',label:'Venta',icon:'💼'},{key:'costos',label:'Costos',icon:'💰'},{key:'proveedores',label:'Proveedores',icon:'🧾'},{key:'resultadoOperativo',label:'Resultado Operativo',icon:'⚖️'},{key:'hhVenta',label:'HH Venta',icon:'👷'},{key:'corteEquipos',label:'Corte Equipos',icon:'✂️'}]},
