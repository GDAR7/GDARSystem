  ...
  controlEquipos:{label:'Control de Equipos',icon:'🚜',color:'#06b6d4',prefix:'ECOCEQ',
    modules:[{key:'dashEquipos',label:'Dashboard',icon:'📊'},{key:'flotaEquipos',label:'Flota de Equipos',icon:'🗂️'},{key:'lineaAmarilla',label:'Línea Amarilla',icon:'🟡'},{key:'lineaBlanca',label:'Línea Blanca',icon:'⚪'},{key:'vehiculosMenores',label:'Vehículos Menores',icon:'🚗'},{key:'equiposMenores',label:'Menores',icon:'🔩'},{key:'panelHoras',label:'Panel Horas Máq.',icon:'⏱️'},{key:'reporteMensual',label:'Mensual al Corte',icon:'📈'},{key:'reporteEquipos',label:'Reporte de Equipos',icon:'📄'},{
              ...
              children:[
                ...
                {key:'areasTrabajo',   label:'Áreas de Trabajo',   icon:'🏞️'},
...
const SUPA_TABLES={
  ...
  presupCDir:'presup_c_dir',       // Control de Costos · Costo Directo: presupuesto meta
  valorCDir:'valor_c_dir',         // Control de Costos · Costo Directo: valorización por período
  comentariosDia:'comentarios_dia',// Panel de Horas · Utilización Diaria: observaciones del pie del PDF
  alimPrecios:'alim_precios',      // Bienestar Social · Alimentación: precios de la concesionaria por período
  alimLocales:'alim_locales',      // Bienestar Social · Alimentación: procedencias que comen 2 veces
  alimRancho:'alim_rancho'         // Bienestar Social · Alimentación: rancho frío cargado a mano
};
